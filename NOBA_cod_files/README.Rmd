...
#### Workflow
- Put `NOBA_sacc_38` folder (Atlantisom output) in the `NOBA_cod_files/` folder
- Modify `NOBACOD_atlantisom2SS.R` to convert Atlantisom output to SS input. 

  - The SS input files in `NOBA_cod_files/output/B` were used as an templates. 
  - We have finished conversion for `data.ss` and `control.ss`.
